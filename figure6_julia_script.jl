...
function make_drop_plots(path, output)
    ...
    p1 = histogram(arr1, normalize = :pdf, title = "Rank 1", xlim = (0,1), ylim = (0,10) , ylabel="Normalised Frequency" )
    p2 = histogram(arr2, normalize = :pdf, title = "Rank 2", xlim = (0,1), ylim = (0,10) )
    p3 = histogram(arr3, normalize = :pdf, title = "Rank 3", xlim = (0,1), ylim = (0,10) , ylabel="Normalised Frequency", xlabel = "p(Dropout)")
...
function make_expr_plots(path, output)
    ...
    p1 = histogram(log.(arr1 .+ 1), normalize = :pdf, title = "Rank 1", xlim = (0,10), ylim = (0,2), ylabel="Normalised Frequency" )
    p2 = histogram(log.(arr2 .+ 1), normalize = :pdf, title = "Rank 2", xlim = (0,10), ylim = (0,2) )
    p3 = histogram(log.(arr3 .+ 1), normalize = :pdf, title = "Rank 3", xlim = (0,10), ylim = (0,2), xlabel="log(counts + 1)", ylabel="Normalised Frequency" )
...
normal_hist = plot(normal_hist, ylabel = "Normalised Frequency")
...
normal_dist = plot(TruncatedNormal(0.25, 0.06, 0.0, 1.0), legend = false, title = "Normal", linestyle=:solid, linewidth=2*8, xticks = 0:0.5:1, ylabel = "Normalised Frequency", xlabel = "p(choice)")
...
H1_24_normal_hist = plot(H1_24_normal_hist, ylabel = "Normalised Frequency")
...
H9_24_normal_hist = plot(H9_24_normal_hist, ylabel = "Normalised Frequency")
...
H9_96_normal_hist = plot(H9_96_normal_hist, ylabel = "Normalised Frequency")
...
size = (1000 * 8,1000 *8), axis = (font(120)), titlefontsize=120, margin = 80mm)
