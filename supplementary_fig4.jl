...
function make_hist(path, titleArg)
    ...
    if titleArg == "3 Isoforms" && path == "figures/figure5_data/Weibull_H9_96_scnorm_counts.txt_3_isoforms_array.txt"
        #Untransformed plot
        p1 = histogram(Arr,
        title = titleArg,
        xlims = (0, 4),
...
savefig(p3, "figures/supplementary_figs/figure4.png")
